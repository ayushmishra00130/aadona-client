...
const TechSquad = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        console.log('✅ Tech Squad request submitted:', data);
        alert(`Tech Squad request submitted successfully! Ticket: ${data.data.squadTicketNumber}`);
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input name="firstName" value={formData.firstName} onChange={handleChange} className={inputBase} placeholder="Enter first name" required />
                    </div>
                    ...
                    <div>
                      ...
                      <input name="lastName" value={formData.lastName} onChange={handleChange} className={inputBase} placeholder="Enter last name" required />
                    </div>
                    ...
                    <div>
                      ...
                      <input type="email" name="email" value={formData.email} onChange={handleChange} className={inputBase} placeholder="you@example.com" required />
                    </div>
                    ...
                    <div>
                      ...
                      <input name="phone" value={formData.phone} onChange={handleChange} className={inputBase} placeholder="Enter phone number" required />
                    </div>
                    ...
                    <div>
                      ...
                      <input name="productModel" value={formData.productModel} onChange={handleChange} className={inputBase} placeholder="e.g., Switch-200" />
                    </div>
                    ...
                    <div>
                      ...
                      <input name="serialNumber" value={formData.serialNumber} onChange={handleChange} className={inputBase} placeholder="Enter serial number" />
                    </div>
                    ...
                    <div>
                      ...
                      <select name="serviceType" value={formData.serviceType} onChange={handleChange} className={inputBase + " bg-white"} required>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input type="date" name="preferredDate" value={formData.preferredDate} onChange={handleChange} className={inputBase} />
