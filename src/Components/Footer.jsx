        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 space-y-3 text-sm">
            <h4 className="text-xl font-bold">
              <span className={ACCENT_GREEN}>AADONA</span>
            </h4>
          ...
          <div className="mt-4 md:mt-0">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/warrantyRegistration" className={`hover:${ACCENT_GREEN} transition duration-300`}>Warranty Registration</Link></li>
              <li><Link to="/whistleBlower" className={`hover:${ACCENT_GREEN} transition duration-300`}>Whistle Blower</Link></li>
              <li><Link to="/careers" className={`hover:${ACCENT_GREEN} transition duration-300`}>Careers</Link></li>
              <li><Link to="/contactus" className={`hover:${ACCENT_GREEN} transition duration-300`}>Contact Us</Link></li>
            </ul>
          </div>
